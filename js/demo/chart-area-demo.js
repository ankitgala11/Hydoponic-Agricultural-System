...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [334, 337, 340, 340, 345, 340, 334],
    }],
  },
  options: {
    maintainAspectRatio: false,
...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [6.8, 6.9, 7.0, 7.2, 7.4, 7.0, 6.7],
    }],
  },
  options: {
    maintainAspectRatio: false,
...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [1431, 1439, 1445, 1450, 1460, 1446, 1440],
    }],
  },
  options: {
    maintainAspectRatio: false,
    ...
    tooltips: {
      ...
      callbacks: {
        label: function(tooltipItem, chart) {
          var datasetLabel = chart.datasets[tooltipItem.datasetIndex].label || '';
          return datasetLabel + " " + number_format(tooltipItem.yLabel) + ' EC' ;
        }
      }
    }
  }
...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [343, 352, 359, 370, 367, 360, 350],
    }],
  },
  options: {
    maintainAspectRatio: false,
